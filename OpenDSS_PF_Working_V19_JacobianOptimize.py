...
Ybus = nmp.array(Ybus)
nmp.savetxt("Ybus.csv",Ybus,delimiter=",")
Ybus = nmp.loadtxt("Ybus.csv",delimiter=",")
Ybus = tuple(Ybus)
BusNo = dssCircuit.NumBuses
...
Loadbuses = [6,8,10,18,19,24,32,37,41,50,49,58,61,63,65,68,76,75]
Loadnames = dssLoad.AllNames
Loadshapenames = dssLoadshapes.AllNames
P,Q = Load_extract(Busnames,Loadbuses,Loadnames,Loadshapenames,dssLoad,dssLoadshapes)
